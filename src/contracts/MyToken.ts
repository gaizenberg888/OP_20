...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u128.fromString('100000000000000000000'); // Your max supply. (Here, 1 million tokens)
        const decimals: u8 = 8; // Your decimals.
        const name: string = 'zakkonik'; // Your token name.
        const symbol: string = 'ZKN'; // Your token symbol.
